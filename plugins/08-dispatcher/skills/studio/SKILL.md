...
| NYC address + zoning, FAR, buildable envelope, permits, violations, landmarks, ownership (NYC only) | **NYC Zoning Expert** agent | Agent |
...
- **NYC:** route to the NYC Zoning Expert (legacy).
